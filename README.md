...
More details: [DNSLink Support in Fisherman](https://github.com/ipfs-shipyard/ipfs-companion/blob/master/docs/dnslink.md)
...
More details: [`x-ipfs-path` Header Support in Fisherman](https://github.com/ipfs-shipyard/ipfs-companion/blob/master/docs/x-ipfs-path-header.md)
